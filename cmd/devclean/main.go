...
func main() {
	...
	registry.Register(plugins.NewNodePlugin())
...
func runCLI(reg *plugins.Registry) {
	...
	fmt.Println(subStyle.Render("v0.1.0 · Intelligent Cleaner for macOS Developers") + " " + authorStyle.Render("by @sebavidal10 (github.com/sponsors/sebavidal10)"))
	fmt.Println()
